            ...
            <li className='carousel-slide current-slide'>
              <a>
                <img
                  ...
                  src='../../../public/Movie-poster/Scream.jpg'
                  alt=''
                />
                <div className='carousel-details'>
                  <h2>Scream 7</h2>
                  <p>
                    <span className='carousel-badge'>HD</span> - 114 min Horror,
                    Mystery, Crime
                  </p>
                  <p>
                    When a new Ghostface killer emerges in the quiet town where
                    Sidney Prescott has built a new life, her darkest fears are
                    realized as her daughter...
                  </p>
